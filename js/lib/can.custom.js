 ...
 * Wed, 05 Jun 2013 08:56:57 GMT
 * Licensed MIT
 * Includes: can/construct/construct.js,can/observe/observe.js,can/observe/compute/compute.js,can/model/model.js,can/view/view.js,can/view/ejs/ejs.js,can/control/control.js,can/route/route.js,can/control/route/route.js,can/util/string/string.js
 * Download from: http://bitbuilder.herokuapp.com/can.custom.js?configuration=zepto&plugins=can%2Fconstruct%2Fconstruct.js&plugins=can%2Fobserve%2Fobserve.js&plugins=can%2Fobserve%2Fcompute%2Fcompute.js&plugins=can%2Fmodel%2Fmodel.js&plugins=can%2Fview%2Fview.js&plugins=can%2Fview%2Fejs%2Fejs.js&plugins=can%2Fcontrol%2Fcontrol.js&plugins=can%2Froute%2Froute.js&plugins=can%2Fcontrol%2Froute%2Froute.js&plugins=can%2Futil%2Fstring%2Fstring.js
 */
...
(function(undefined) {
        ...
        var __m9 = (function(can) {
                ...
                can.when = Deferred.when = function() {
                    var args = can.makeArgumentsArray(arguments);
                    if (args.length < 2) {
                        var obj = args[0];
        ...
        var __m3 = (function(can) {
                ...
                $.each(["append", "filter", "addClass", "remove", "data"], function(i, name) {
                        can[name] = function(wrapped) {
                            return wrapped[name].apply(wrapped, can.makeArgumentsArray(arguments).slice(1))
                        }
                    })
                ...
                can.makeArgumentsArray = function(arr){
                    var ret = [];
        ...
        var __m1 = (function(can) {
                ...
                can.extend(can.Construct, {
                        ...
                        extend: function(fullName, klass, proto) {
                            ...
                            var t = [_super_class].concat(can.makeArgumentsArray(arguments)),
        ...
        var __m11 = (function(can, bind) {
                ...
                var Observe = can.Map = can.Observe = can.Construct({
...

                    {
                        ...
                        _triggerChange: function(attr, how, newVal, oldVal) {
                            ...
                            Observe.triggerBatch(this, "change", args);
                        },
                        ...
                        each: function() {
                            ...
                            return can.each.apply(undefined, [this.__get()].concat(can.makeArgumentsArray(arguments)))
                        },
                ...
                can.extend(list.prototype, {
                        ...
                        concat: function() {
                            var args = [];
                            can.each(can.makeArgumentsArray(arguments), function(arg, i) {
                ...
                can.each({
                        ...
                        can.Model[name] = function(oldMethod) {
                            return function() {
                                ...
                                var oldArgs = can.isFunction(args[1]) ? args.splice(0, 1) : args.splice(0, 2);
                                var def = pipe(oldMethod.apply(this, oldArgs), this, method);
                        ...
                        render: function(view, data, helpers, callback) {
                            ...
                            if (deferreds.length) { // Does data contain any deferreds?
                                ...
                                can.when.apply(can, deferreds).then(function(resolved) {
                                        ...
                                        var objs = makeArgumentsArray(arguments),
